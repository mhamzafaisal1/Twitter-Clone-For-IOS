...
class TweetHeader: UICollectionReusableView {
    ...
    private let captionLabel: UILabel = {
        ...
        label.text = "Caption will occupy this space. A sample Caption xxxx"
        return label
    }()
    ...
    override init(frame: CGRect) {
        ...
        captionLabel.anchor(top: stack.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 12, paddingLeft: 20, paddingRight: 20)
        
        addSubview(dateLabel)
        dateLabel.anchor(top: captionLabel.bottomAnchor, left: leftAnchor, paddingTop: 20, paddingLeft: 15)
