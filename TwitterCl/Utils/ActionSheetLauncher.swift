...
class ActionSheetLauncher: NSObject {
    ...
    private lazy var blackView: UIView = {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(handlePopupDismissal))
    ...
    private lazy var cancelButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(handlePopupDismissal), for: .touchUpInside)
        return button
    }()
    ...
    @objc func handlePopupDismissal() {
